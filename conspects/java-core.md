...
Классы должны быть открыты для расширения, но закрыты для изменения. Поведение может быть расширено в связи с изменившимися требованиями, но исходный код такого модуля неприкасаем.
